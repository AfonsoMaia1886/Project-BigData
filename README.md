...
This directory contains the homework project focused on the analysis of an Airbnb database, developed as part of the Big Data course.
The project consists of querying, optimizing, and analyzing data hosted in MongoDB, simulating a consulting role for Airbnb's *Business Intelligence* department.
